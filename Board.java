    ...
    public Board() {
        ...
        addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                int maxTile = getMaxTile(); // Declare and initialize maxTile here
                if (key == KeyEvent.VK_UP) {
                    transpose();        // Transposes (flips) the grid.
                    compressGrid();     // Compresses the grid by moving tiles to remove empty spaces.
                    mergeGrid();        // Merges adjacent tiles with the same value
                ...
                paintGrid();        // Updates the graphical representation of the grid on the screen.
                if (moved) {
                ...
                if (maxTile == 11) { // 2048 = 2^11
                    JOptionPane.showMessageDialog(null, "You won!");
                    dispose(); // Close the window when the game is won
                }
            }
